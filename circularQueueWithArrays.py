...
class Queue:
    ...
    def size(self) -> int:
        ...
        return "No.of elements in the queue is {}".format(abs(self.rear - self.front) + 1)
...
1. Enqueue  2. Dequeue  3. Count of Elements    4. isEmpty  5. Display  6. Exit
Enter your choice : """))
